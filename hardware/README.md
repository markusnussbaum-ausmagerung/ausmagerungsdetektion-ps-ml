...
`fotobox\_steuerung.py` laeuft auf dem Raspberry Pi. Es schaltet die zwoelf LEDs
...
`kalibrierung\_cos4\_weissreferenz.py` berechnet aus einer Weissreferenz die
cos^4-Vignettierungskorrektur und speichert sie fuer die Pipeline.

`kalibrierung\_psi\_led.py` bestimmt die LED-Geometrie (Psi-Kalibrierung) aus
